...
When prompted, confirm the plugin reload (or restart Claude Code) — the skill and the MCP activate after the reload. Then connect your account:

```
/mcp
```

Pick **legalloop** → **Authenticate**, and approve in the browser page that opens (one click if you are signed in to your Legal Loop dashboard).
